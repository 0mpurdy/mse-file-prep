package mse.reader.ministry;

import mse.data.ministry.MinistryAuthor;
import mse.data.ministry.MinistryBook;
import mse.data.ministry.MinistryPage;
import mse.data.ministry.MinistryParagraph;
...
public class MinistryTextReader {
    ...
    public ArrayList<MinistryAuthor> readAllMinistryAuthors(String sourceFolder) {
